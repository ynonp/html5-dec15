...
export default React.createClass({
  ...
  stateFromStore: function(store) {
    return { primes: store.primes };
  },

  setRandomText: function() {
    UserActions.addPrime();
  },

  shouldComponentUpdate: function(nextProps, nextState) {
    return this.state.primes !== nextState.primes;
  },
  ...
  render: function() {
    debugger;
    return (<div>
      {this.state.primes.map(function(p) {
        return <span className="prime">{p}</span>
      })}
